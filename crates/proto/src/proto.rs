...
messages!(
    ...
    (GetRemoteCliInfo, Background),
    (RemoteCliInfo, Background),
    (OpenRemoteCliPaths, Background),
    (CancelRemoteCliRequest, Background),
...
request_messages!(
    ...
    (LoadMergeBaseDiff, LoadCommitDiffResponse),
    ...
    (RemoteStarted, Ack),
    (GetRemoteCliInfo, RemoteCliInfo),
    (OpenRemoteCliPaths, Ack),
